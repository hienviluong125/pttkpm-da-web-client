<template>
  <b-row class="bg-gray p-5 m-5">
    <b-col lg="5" md="12" sm="12" xs="12" class="pr-lg-5 mt-sm-5">
      <p>GLOBAL REACH</p>
    ...
    <b-col lg="7" md="12" sm="12" xs="12" class="mt-md-5 mt-xs-5">
      <img src="image/earth.jpg" class="w-100" />
    </b-col>
  </b-row>
</template>
